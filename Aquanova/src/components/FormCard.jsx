    ...
    >
      ...
      <div className='flex flex-col flex-1 p-5'> 
        ...
        <div className='flex flex-wrap gap-2 mb-4 justify-center'>
          <FormStateElement formState='state' label={active} />
        ...
        <div className='flex flex-col gap-3 mt-auto'>
          ...
          <div className='flex flex-wrap items-center justify-between pt-2 border-t border-gray-100'>
            ...
            <button 
              onClick={onPreview}
              className='flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium text-white bg-[var(--green-buttons)] hover:brightness-110 transition-colors'
            >  
