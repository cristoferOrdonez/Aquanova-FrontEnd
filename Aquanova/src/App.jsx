...
import AquabotWidget from './components/Aquabot/AquabotWidget'
...
function App() {
  ...
  const showNavbar =
    ['/home', '/forms', '/neighborhoods', '/user-management'].includes(location.pathname) ||
    location.pathname.startsWith('/referidos');
